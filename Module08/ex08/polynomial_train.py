...
from Module06.ex05.z_score import zscore
...
def main():
    ...
    plt.bar(list(mse_scores.keys()), list(mse_scores.values()), color='skyblue', edgecolor='midnightblue')
    ...
    for degree in range(1, 7):
        ...
        X_poly_cont_norm = zscore(X_poly_cont)  # normalisation des donnees
    ...
    plt.ylabel("Score")
    plt.title("Polynomial models vs data (with normalization)")
    plt.legend()
