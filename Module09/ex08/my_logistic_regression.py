...
from Module08.ex02.log_loss import log_loss_elem_
...
class MyLogisticRegression():
    ...
    """
    def __init__(self, theta, alpha=0.001, max_iter=1000, lambda_=1.0):
        self.alpha = alpha
    ...
    def fit_(self, x, y):
        ...
        for _ in range(self.max_iter):
            grad = vec_reg_logistic_grad(y, x, new_theta, self.lambda_)
            if grad is None:
                return None
